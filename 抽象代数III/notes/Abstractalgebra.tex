...
\begin{proof}
Regard $S$ as a finite-dimensional $k$-vector space.
...
\begin{theorem}
(Krull--Schmidt) Let $M$ be an $R$-module with a composition series.
Suppose
\[
...
\begin{proof}
Every element of $Re$ can be written as
\[
ae = ae_1+\cdots+ae_n.
\]
...
\begin{corollary}
For an idempotent $e \in R$, the following are equivalent:
(1) $e$ is primitive.
