...
representations, the irreducible morphisms between them, and the basic non-split short exact sequences. (In fact almost split sequences, you can check the definition in the book of Schiffler).
