...
\begin{proposition}
$ i \in Q_0 $ is a sink if and only if $ P(i)=S(i) $ is simple; $ i \in Q_0 $ is a source if and only if $ I(i)=S(i) $ is simple.
\end{proposition}

\begin{proposition}\leavevmode
    \begin{enumerate}
\item Let $ P $ and $ P' $ be representations of $ Q $, $ P,P' $ are both projectives if and only if $ P \oplus P' $ is projective.     
\item Let $ I $ and $ I' $ be representations of $ Q $, $ I,I' $ are both injective if and only if $ I \oplus I' $ is injective. 
    \end{enumerate}
\end{proposition}
...
\begin{proposition}
$ S(i) $, $ P(i) $, $ I(i) $ are all indecomposable representations of $ Q $.    
\end{proposition}
