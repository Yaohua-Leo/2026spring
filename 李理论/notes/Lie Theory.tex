...
We can also find Lie algebras from the involution of an associative algebra. Let $ A $ be an associative algebra. $ *: \to A $ is a linear transformation. $ * $ is called a an involution if $ (a^*)^* =a $ and $ (ab)^*=b^*a^* $, $ \forall a,b \in A $.
