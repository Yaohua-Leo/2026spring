...
% Avoid breakable-box warnings about zero-height first parts (thmtools + tcolorbox v6+).
% Match after upper strut so inner top/bottom padding looks symmetric (before-only strut skews upward).
\tcbset{before upper={\strut}, after upper={\strut}}
% 6. 参考文献
...
\begin{lemma}
    ...
    \begin{proof}
    Fix $a \in L$. Since $\operatorname{ad} a$ is semisimple,
    \[
